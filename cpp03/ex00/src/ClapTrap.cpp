...
/*   Updated: 2024/09/23 08:54:56 by ampjimen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0) {
    std::cout << GREEN << BOLD << "ClapTrap " << _name << " constructed!" << RESET << std::endl;
    displayPoints();
}
...
// Destructor
ClapTrap::~ClapTrap() {
    std::cout << PURPLE << BOLD << "ClapTrap " << _name << " destructed!" << RESET << std::endl;
}
